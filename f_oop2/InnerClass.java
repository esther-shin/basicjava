...
class Outer{
	...
	class InstanceInner{
		...
		void method(){
			...
			System.out.println(var);//method안에 있는 지역 변수
			System.out.println(this.var);//class InstanceInner
			System.out.println(Outer.this.var);//class Outer
	...
	static class StaticInner{
		...
		//int inner1 = instanceVar;//사용 불가한 이유???
		int inner2 = classVar;
