...
public class SampleClass {
	...
	void method1(){// 리턴 타입이 없을때   void 사용. ()괄호안에 아무것도 없음
		//파라미터 부재.
		System.out.println("파라미터도 리턴타입도 없는 메서드");
	}
	
	void method2(int parameter){//리턴 타입이 없고 파라미터가 있는 경우
	...
	String method3(){
		...
		//결과물을 돌려주는 역활과 종료시켜주는 역할을하며
		//같은 타입의 리턴 값을 돌려줘야 됨
		//리턴 타입이 없는 메서드(void)에서는 메서드를 종료시킨다.
	}
