...
//	[7-3] 오버라이딩의 정의와 필요성에 대해서 설명하시오.
	...
	//답: 상속받은 메서드의 내용 변경, 자손 클래스에 맞게 변경해야 하는 경우 필요
...
// [정답] 조상에 정의된 인스턴스 변수들이 초기화
	
	
// [7-7] 다음 코드의 실행했을 때 호출되는 생성자의 순서와 실행결과를
...
//	getter와 setter메서드를 추가하라.
	...
	//source->generator getter and setter누르기
...
// 답:Math클래스의 모든 메서드가 static메서드이고 인스턴스변수가 존재하지 않기 때
