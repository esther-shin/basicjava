...
/*
		 ...
		 [연습문제]/ch6/Exercise6_4.java
			...
			System.out.println("평균:"+s.getAverage());
				...
				float getAverage(){
					...
					average= sum/((float)3*10+0.5)/10f;
					return average;
				} 
		...
		[6-5] 다음과 같은 실행결과를 얻도록 Student클래스에 생성자와 
		info()를 추가하시오.
			...
			공유해야 하는 변수에 static 필요, 인스턴스 변수는 인스턴스 메서드로하고
			나머지는  static 메서드로 해야됨.
		...
		instanceMethod1();
		 ...
		 답: a 라인. 클래스 변수는 인스턴스 변수 사용 불가
		 	b라인- 객체를 생성해야 인스턴스 변수 사용 가능.
		    d라인- 인스턴스 멤머가 존재하지 않을 수도 있음.
		...
		public static void change(String str) {//값을 보내주려면 void 를 string으로 변경
		str += "456";
			}
		...
		change(str);//String= change(str) 이라고 해야됨.
		...
		System.out.println("After change:"+str);
		 ...
		 답: ABC123
		 "After change" "ABC123"
		 //스트링이라 변경 안됨. 문자열이 변경되면 새로운 객체를 만든다.(=주소가 변경된다)
		...
		[Hint] String클래스의 charAt(int i)메서드를 사용하면 문자열의 i번째 
		위치한 문자를 얻을 수 있다.
